...
public class BoardController {
    ...
    public String getList(Model model, @RequestParam(value="searchType", defaultValue = "") String searchType,
        ...
        model.addAttribute("list", boardService.getSearch(searchType, words, page));
        model.addAttribute("page", boardService.BoardPageCalc(searchType, words, page));
